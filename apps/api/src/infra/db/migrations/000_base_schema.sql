...
create table if not exists k1_field_values (
  id uuid primary key,
...
create table if not exists k1_reported_distributions (
  id uuid primary key,
  k1_document_id uuid not null references k1_documents(id),
  entity_id uuid not null references entities(id),
...
create table if not exists partnership_fmv_snapshots (
  id uuid primary key,
  partnership_id uuid not null references partnerships(id),
...
create table if not exists k1_issues (
  id uuid primary key,
  k1_document_id uuid not null references k1_documents(id),
...
create table if not exists partnership_annual_activity (
  id uuid primary key,
  entity_id uuid not null references entities(id),
  partnership_id uuid not null references partnerships(id),
  tax_year int not null,
