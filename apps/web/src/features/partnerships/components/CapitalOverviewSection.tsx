    ...
    >
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4 p-5">
        <KpiCard
          ...
          icon={<LandmarkIcon className="w-4 h-4 text-primary" />}
        />
        <KpiCard
          label="Paid-In"
          value={formatUsd(overview.paidInUsd)}
          icon={<HandCoinsIcon className="w-4 h-4 text-primary" />}
        />
        <KpiCard
          label="% Called"
        ...
        <KpiCard
          ...
          icon={<ArrowRightLeftIcon className="w-4 h-4 text-primary" />}
        />
        <KpiCard
          label="Residual Value"
          value={formatUsd(overview.residualValueUsd)}
          icon={<BarChart3Icon className="w-4 h-4 text-primary" />}
        />
        <KpiCard label="DPI" value={formatMultiple(overview.dpi)} />
        <KpiCard label="RVPI" value={formatMultiple(overview.rvpi)} />
        <KpiCard label="TVPI" value={formatMultiple(overview.tvpi)} />
      </div>
    </SectionCard>
  )
}
