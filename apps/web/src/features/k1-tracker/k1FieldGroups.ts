...
export const K1_FIELD_GROUPS: K1FieldGroup[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      signed('box_11_other_income_loss', 'Line 11 ZZ - Other income (loss)'),
  ...
  },
  {
    ...
    signHint: 'Enter deductions as positive decrease amounts. Line 19 distributions may be entered with the sign shown on the K-1.',
    fields: [
      ...
      signed('box_19_distributions', 'Line 19 - Distributions'),
  ...
  },
  {
    ...
    signHint: 'Current-year income and other increases or decreases are signed. Enter withdrawals and distributions as negative amounts.',
    fields: [
      ...
      signed('section_l_withdrawals_distributions', 'Section L withdrawals and distributions'),
