...
export function OutsideBasisPanel({ calculation, detail }: { calculation: K1TrackerCalculation; detail: K1TrackerYearDetail }) {
  const rows: Array<[string, unknown, string[]]> = [
    ...
    ['Liability increase', calculation.basis.liabilityIncrease, ['liability_nonrecourse_beginning', 'liability_nonrecourse_ending', 'liability_qualified_nonrecourse_beginning', 'liability_qualified_nonrecourse_ending', 'liability_recourse_beginning', 'liability_recourse_ending']],
    ['Cash and property distributions', calculation.distribution.cashOrPropertyDistribution, ['box_19_distributions']],
    ['Liability relief', calculation.distribution.liabilityRelief, ['liability_nonrecourse_beginning', 'liability_nonrecourse_ending', 'liability_qualified_nonrecourse_beginning', 'liability_qualified_nonrecourse_ending', 'liability_recourse_beginning', 'liability_recourse_ending']],
