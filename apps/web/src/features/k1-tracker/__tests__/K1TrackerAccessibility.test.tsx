...
describe('K1 Tracker accessibility', () => {
  it('gives the comparison drawer an accessible name and keyboard-operable year choices', () => {
    render(<CompareYearsDrawer years={[2023, 2024].map((taxYear) => ({ taxYear, status: 'IMPORTED' as const, revision: 1, capitalContributed: '100.00', distributions: '10.00', endingOutsideBasis: '100.00', cumulativeSuspendedLoss: '0.00', taxableExcessDistribution: '0.00', sectionLDifference: '0.00', warningCount: 0, sourceConflictCount: 0 }))} selectedYear={2024} onClose={vi.fn()} />)
