  ...
  return (
    <div className="relative border-l-4 border-jackson-gold pl-3 sm:pl-5">
      <PageHeader
        ...
        subtitle="A filterable view of commitments, valuations, and lifetime performance by entity-fund position."
      ...
      <main className="mt-6 space-y-5" aria-label="Investment tracker results">
        <div className="flex min-h-10 flex-wrap items-center gap-3">
          <p className="mr-auto text-sm font-semibold text-gray-700" aria-live="polite" aria-atomic="true">
            {tracker.data ? `${tracker.data.positions.length} position${tracker.data.positions.length === 1 ? '' : 's'}` : 'Loading investment results'}
          </p>
