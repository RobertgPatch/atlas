        ...
        {mode === 'new' && <>
          <section aria-labelledby="partnership-profile-heading" className="border-t border-gray-200 pt-5">
            ...
            <div className="mt-4 grid gap-4 sm:grid-cols-2">
              ...
              <label className="block text-sm font-medium text-gray-800">EIN <span className="font-normal text-gray-500">(masked on overview)</span><input inputMode="numeric" autoComplete="off" value={ein} onChange={(event) => setEin(formatEinInput(event.target.value))} placeholder="12-3456789" pattern="[0-9]{2}-[0-9]{7}" className="mt-1 min-h-11 w-full rounded-md border border-gray-300 px-3 outline-none focus:border-jackson-gold focus:ring-2 focus:ring-jackson-gold/30" /><span className="mt-1 block text-xs font-normal text-gray-500">Formatted automatically as 12-3456789.</span></label>
