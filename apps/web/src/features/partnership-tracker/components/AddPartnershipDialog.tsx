        ...
        {mode === 'new' && <>
          <section aria-labelledby="partnership-profile-heading" className="border-t border-gray-200 pt-5">
            ...
            <div className="mt-4 grid gap-4 sm:grid-cols-2">
              <label className="block text-sm font-medium text-gray-800">Inception date<input type="date" max={new Date().toISOString().slice(0, 10)} value={inceptionDate} onChange={(event) => setInceptionDate(event.target.value)} className="mt-1 min-h-11 w-full rounded-md border border-gray-300 px-3 outline-none focus:border-atlas-gold focus:ring-2 focus:ring-atlas-gold/30" /></label>
              <label className="block text-sm font-medium text-gray-800">EIN <span className="font-normal text-gray-500">(masked on overview)</span><input inputMode="numeric" autoComplete="off" value={ein} onChange={(event) => setEin(event.target.value)} placeholder="12-3456789" pattern="[0-9]{2}-?[0-9]{7}" className="mt-1 min-h-11 w-full rounded-md border border-gray-300 px-3 outline-none focus:border-atlas-gold focus:ring-2 focus:ring-atlas-gold/30" /></label>
              <label className="block text-sm font-medium text-gray-800 sm:col-span-2">Fund manager<input value={fundManager} maxLength={200} onChange={(event) => setFundManager(event.target.value)} className="mt-1 min-h-11 w-full rounded-md border border-gray-300 px-3 outline-none focus:border-atlas-gold focus:ring-2 focus:ring-atlas-gold/30" /></label>
              <label className="block text-sm font-medium text-gray-800 sm:col-span-2">Address<input value={addressLine1} maxLength={200} onChange={(event) => setAddressLine1(event.target.value)} placeholder="Street address" className="mt-1 min-h-11 w-full rounded-md border border-gray-300 px-3 outline-none focus:border-atlas-gold focus:ring-2 focus:ring-atlas-gold/30" /></label>
              <label className="block text-sm font-medium text-gray-800 sm:col-span-2"><span className="sr-only">Address line 2</span><input value={addressLine2} maxLength={200} onChange={(event) => setAddressLine2(event.target.value)} placeholder="Suite, unit, or building (optional)" className="min-h-11 w-full rounded-md border border-gray-300 px-3 outline-none focus:border-atlas-gold focus:ring-2 focus:ring-atlas-gold/30" /></label>
              <label className="block text-sm font-medium text-gray-800">City<input value={addressCity} maxLength={120} onChange={(event) => setAddressCity(event.target.value)} className="mt-1 min-h-11 w-full rounded-md border border-gray-300 px-3 outline-none focus:border-atlas-gold focus:ring-2 focus:ring-atlas-gold/30" /></label>
              <label className="block text-sm font-medium text-gray-800">State / region<input value={addressRegion} maxLength={120} onChange={(event) => setAddressRegion(event.target.value)} className="mt-1 min-h-11 w-full rounded-md border border-gray-300 px-3 outline-none focus:border-atlas-gold focus:ring-2 focus:ring-atlas-gold/30" /></label>
              <label className="block text-sm font-medium text-gray-800">Postal code<input value={addressPostalCode} maxLength={30} onChange={(event) => setAddressPostalCode(event.target.value)} className="mt-1 min-h-11 w-full rounded-md border border-gray-300 px-3 outline-none focus:border-atlas-gold focus:ring-2 focus:ring-atlas-gold/30" /></label>
              <label className="block text-sm font-medium text-gray-800">Country<input value={addressCountry} maxLength={120} onChange={(event) => setAddressCountry(event.target.value)} className="mt-1 min-h-11 w-full rounded-md border border-gray-300 px-3 outline-none focus:border-atlas-gold focus:ring-2 focus:ring-atlas-gold/30" /></label>
            </div>
          </section>
          <section aria-labelledby="entry-valuation-heading" className="border-t border-gray-200 pt-5"><h3 id="entry-valuation-heading" className="font-serif text-lg font-semibold text-gray-950">Entry valuation</h3><p className="mt-1 text-xs text-gray-500">Optional. This becomes the first dated NAV entry.</p><div className="mt-4 grid gap-4 sm:grid-cols-2"><label className="block text-sm font-medium text-gray-800">Initial valuation<CurrencyInput value={initialValuationAmount} onChange={setInitialValuationAmount} allowNegative={false} placeholder="$0.00" /></label><label className="block text-sm font-medium text-gray-800">Valuation date<input type="date" value={initialValuationDate} onChange={(event) => setInitialValuationDate(event.target.value)} className="mt-1 min-h-11 w-full rounded-md border border-gray-300 px-3 outline-none focus:border-atlas-gold focus:ring-2 focus:ring-atlas-gold/30" /></label></div></section>
        </>}
