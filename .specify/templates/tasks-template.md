...
**Tests**: Tests are REQUIRED for every behavior change. Include the lowest useful
level plus integration, contract, end-to-end, migration, infrastructure, security,
or recovery tests whenever a boundary or constitutional risk is affected.
...
- [ ] T005 Setup database schema and restartable migration framework
- [ ] T006 [P] Implement unique identity, MFA, and deny-by-default authorization foundations
- [ ] T007 [P] Setup API routing, tenant/entity scope enforcement, and middleware structure
- [ ] T008 Create base models/entities with provenance and audit ownership
- [ ] T009 Configure redacted error handling, security logging, and audit infrastructure
- [ ] T010 Setup environment, secret, key, and least-privilege configuration management
- [ ] T011 Define backup, restore, RPO/RTO, rollback, and incident-response evidence
...
- [ ] TXXX [P] Additional risk-based regression tests in tests/unit/
- [ ] TXXX Verify ASVS, threat-model, least-privilege, secret, and dependency gates
...
- Test strategy and negative cases MUST be defined before implementation
- Tests MUST demonstrate failure against missing or incorrect protections before the story is accepted
...
- Define tests before implementation and verify they detect missing or incorrect behavior
